...
void audio_read(char* filename,double** wav_data,long* num_samples) {

 // open file
 //printf("Opening  file...\n");
 FILE *ptr = fopen(filename, "rb");
 if (ptr == NULL) {
    printf("Error opening file in wave.c\n");
    exit(1);
 }
 ...
 *wav_data = malloc(*num_samples*sizeof(double));
 if (wav_data == NULL) printf("Error. Alloc wav_data in audio_read.\n");
            ...
            for (i=0; i < *num_samples; i++) {
                ...
                if (read == 1) {
                    ...
                    for (xchannels = 0; xchannels < header.channels; xchannels ++ ) {
                        //if (i<10) printf("Channel#%d : ", (xchannels+1));
